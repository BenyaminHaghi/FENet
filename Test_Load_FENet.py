...
CHECKPOINT = '.\\checkpoints\\db20_architechture'
# CHECKPOINT = '.\\checkpoints\\db20-alternative-iqk20aq0'
# CHECKPOINT = '.\\checkpoints\\efficient-model-volcanic486'
...
if __name__ == '__main__':
    ...
    fenet = make_fenet_from_checkpoint(CHECKPOINT, device)    # load custom fenet that we are evaluating
    fenet.normalize_at_end = True

    # evaluate model
    with wandb.init(project="fenet_testbed", config=config, anonymous='allow') as run:
